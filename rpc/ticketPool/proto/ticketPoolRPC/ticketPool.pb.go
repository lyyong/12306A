...
type Ticket struct {
	...
	TrainId        int32  `protobuf:"varint,2,opt,name=train_id,json=trainId,proto3" json:"train_id,omitempty"`                        // 列车id
	StartStationId int32  `protobuf:"varint,3,opt,name=start_station_id,json=startStationId,proto3" json:"start_station_id,omitempty"` // 起始站
	StartTime      string `protobuf:"bytes,4,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	DestStationId  int32  `protobuf:"varint,5,opt,name=dest_station_id,json=destStationId,proto3" json:"dest_station_id,omitempty"` // 目的站
	...
	SeatTypeId     int32  `protobuf:"varint,8,opt,name=seat_type_id,json=seatTypeId,proto3" json:"seat_type_id,omitempty"`          // 座位类型（硬座、卧铺、一等、二等）
	...
	PassengerId    int32  `protobuf:"varint,11,opt,name=passenger_id,json=passengerId,proto3" json:"passenger_id,omitempty"`        // 乘车人id
	IndentId       int32  `protobuf:"varint,12,opt,name=indent_id,json=indentId,proto3" json:"indent_id,omitempty"`                 // 订单号
...
func (x *Ticket) GetTrainId() int32 {
	if x != nil {
		return x.TrainId
	}
	return 0
...
func (x *Ticket) GetStartStationId() int32 {
	if x != nil {
...
func (x *Ticket) GetDestStationId() int32 {
	if x != nil {
...
func (x *Ticket) GetSeatTypeId() int32 {
	if x != nil {
		return x.SeatTypeId
	}
	return 0
...
func (x *Ticket) GetPassengerId() int32 {
	if x != nil {
...
func (x *Ticket) GetIndentId() int32 {
	if x != nil {
		return x.IndentId
	}
	return 0
...
type GetTicketRequest struct {
	...
	DestStationId  int32            `protobuf:"varint,3,opt,name=dest_station_id,json=destStationId,proto3" json:"dest_station_id,omitempty"`
...
func (x *GetTicketRequest) GetTrainId() int32 {
	if x != nil {
		return x.TrainId
	}
	return 0
...
func (x *GetTicketRequest) GetStartStationId() int32 {
	if x != nil {
		return x.StartStationId
	}
	return 0
...
func (x *GetTicketRequest) GetDestStationId() int32 {
	if x != nil {
		return x.DestStationId
	}
	return 0
...
type PassengerInfo struct {
	...
	SeatTypeId  int32  `protobuf:"varint,2,opt,name=seat_type_id,json=seatTypeId,proto3" json:"seat_type_id,omitempty"`
...
func (x *PassengerInfo) GetPassengerId() int32 {
	if x != nil {
		return x.PassengerId
	}
	return 0
...
func (x *PassengerInfo) GetSeatTypeId() int32 {
	if x != nil {
		return x.SeatTypeId
	}
	return 0
...
type GetTicketNumberRequest struct {
	...
	TrainId        []int32 `protobuf:"varint,1,rep,packed,name=train_id,json=trainId,proto3" json:"train_id,omitempty"`
	StartStationId int32   `protobuf:"varint,2,opt,name=start_station_id,json=startStationId,proto3" json:"start_station_id,omitempty"`
	DestStationId  int32   `protobuf:"varint,3,opt,name=dest_station_id,json=destStationId,proto3" json:"dest_station_id,omitempty"`
	Date           string  `protobuf:"bytes,4,opt,name=date,proto3" json:"date,omitempty"`
}
...
func (x *GetTicketNumberRequest) GetTrainId() []int32 {
	if x != nil {
		return x.TrainId
	}
	return nil
...
func (x *GetTicketNumberRequest) GetStartStationId() int32 {
	if x != nil {
		return x.StartStationId
	}
	return 0
...
func (x *GetTicketNumberRequest) GetDestStationId() int32 {
	if x != nil {
		return x.DestStationId
	}
	return 0
...
func (x *TrainTicketInfo) GetTrainId() int32 {
	if x != nil {
		return x.TrainId
	}
	return 0
...
type SeatInfo struct {
	...
	SeatTypeId int32 `protobuf:"varint,1,opt,name=seat_type_id,json=seatTypeId,proto3" json:"seat_type_id,omitempty"`
...
func (x *SeatInfo) GetSeatTypeId() int32 {
	if x != nil {
		return x.SeatTypeId
	}
	return 0
...
var file_ticketPool_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07,
	...
	0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x64, 0x65, 0x73, 0x74, 0x53,
	...
	0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x65, 0x61, 0x74, 0x54, 0x79, 0x70, 0x65, 0x49, 0x64, 0x12,
	...
	0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0b, 0x70, 0x61, 0x73, 0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09,
	0x69, 0x6e, 0x64, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52,
	...
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x73, 0x74, 0x61,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x64, 0x65, 0x73, 0x74, 0x53, 0x74, 0x61, 0x74, 0x69, 0x6f,
	...
	0x08, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x03, 0x28, 0x05, 0x52,
	...
	0x28, 0x05, 0x52, 0x0e, 0x73, 0x74, 0x61, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x64, 0x65, 0x73,
	...
	0x01, 0x28, 0x05, 0x52, 0x07, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x34, 0x0a, 0x09,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x65, 0x61, 0x74, 0x54, 0x79, 0x70, 0x65, 0x49, 0x64,
