...
type Ticket struct {
	...
	OrderId        uint32 `protobuf:"varint,16,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`             // 订单号
...
func (x *Ticket) GetOrderId() uint32 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
var file_ticketPool_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05,
